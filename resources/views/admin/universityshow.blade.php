                        ...
                        <div class="default-according" id="accordion">
                            ...
                            <div class="card">
                                ...
                                <form action="{{url('unistatus/'.$data->id)}}" method="post">
                                    ...
                                    <button class="btn btn-success" type="submit"
                                        onclick="myFunction()">Approve</button>
                                    @endif
                                    @if($data->accept == '1')
                            ...
                            <div class="card">
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class=" col-sm-6 col-lg-6">
                                        <h5><img src="{{ url('uploads/candidateImage/'.$data->candidateImage)}}"
                                                ...
                                                data-bs-target="#myModal"></h5>
                                        <a class="btn btn-primary"
                                            href="{{ url('uploads/candidateImage/'.$data->candidateImage)}}"
                                            download>Download</a>
                                    </div>
                                </div>
                                <div class="card-header" id="headingOne">
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class=" col-sm-6 col-lg-6">
                                        <h5><a
                                                href="{{ url('uploads/publishedWorks/'.$data->publishedWorks)}}">{{$data->publishedWorks }}</a>
                                        </h5>
                                    </div>
                                </div> 
                            </div>
