                            ...
                            <div class="card">
                                ...
                                <div class="collapse show" id="collapseeight" aria-labelledby="headingOne" data-bs-parent="#accordion">
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class=" col-sm-6 col-lg-6">
                                        <h5> <img src="{{  asset('authentic/image/' . $data->authentic_cv) }}" alt="image" width="70px" class="img-popup"  data-bs-toggle="modal" data-bs-target="#myModal"></h5> 
                                            <a class= "btn btn-primary" href="{{  asset('authentic/image/' . $data->authentic_cv) }}" download>Download</a>
                                        </div> 
                                    </div>
                                    <div class="row mt-3">
                                        <div class="col-sm-6 col-lg-6">
                                        ...
                                        <div class=" col-sm-6 col-lg-6">
                                          <h5> <img src="{{  asset('authentic/image/' . $data->authentic_cv1) }}" alt="image" width="70px" class="img-popup"  data-bs-toggle="modal" data-bs-target="#myModal"></h5> 
                                            <a class= "btn btn-primary" href="{{  asset('authentic/image/' . $data->authentic_cv1) }}" download>Download</a>
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class=" col-sm-6 col-lg-6">
                                        <h5>  <img src="{{  asset('authentic/image/' . $data->authentic_cv2) }}" alt="image" width="70px" class="img-popup"  data-bs-toggle="modal" data-bs-target="#myModal"></h5> 
                                            <a class= "btn btn-primary" href="{{  asset('authentic/image/' . $data->authentic_cv2) }}" download>Download</a>
                                        </div>
                                    </div>
                                    <div class="row mt-3">
                                        <div class="col-sm-6 col-lg-6">
                                        ...
                                        <div class=" col-sm-6 col-lg-6">
                                        <h5> <img src="{{  asset('authentic/image/' . $data->authentic_cv3) }}" alt="image" width="70px" class="img-popup"  data-bs-toggle="modal" data-bs-target="#myModal"></h5> 
                                            <a class= "btn btn-primary" href="{{  asset('authentic/image/' . $data->authentic_cv3) }}" download>Download</a>
                                        </div>
                                    </div>
