            ...
            <div class="col-sm-12 col-lg-12">
                    ...
                    <div class="card-body">
                        <div class="default-according" id="accordion">
                            ...
                            <div class="card">
                                ...
                                <form action=" {{ url('authenticity/'.$data->id) }} " method="post">
                                    @method('PUT')
                                    @csrf
                                    @if($data->accept == '0')
                                ...
                                @endif -->
                                @if(auth()->user()->role == "admin1" || auth()->user()->role == "admin2")
                                <form method="post" action="{{url('authenticity/'.$data->id)}}">
                ...
                <div class="card">
                    <div class="collapse show" id="collapsetwo" aria-labelledby="headingOne" data-bs-parent="#accordion">
                        ...
                        @foreach($data->authentic_cv as $key => $image)
                        <div class="row mt-3">
                            <div class="col-sm-6 col-lg-6">
                                <h5 style="margin-left: 25%;">
                                    جهة الشهادة Pdf, jpg, png </h5>
                            </div>
                            <div class=" col-sm-6 col-lg-6">
                                <h5><img src="{{ asset('authentic/image/'.$image)}}" width="70px" class="img-popup" data-bs-toggle="modal" data-bs-target="#myModal"></h5>
                                <a type="button" class="btn btn-primary" href="{{ asset('authentic/image/'.$image)}}" download>Download</a>
                            </div>
                        </div>
