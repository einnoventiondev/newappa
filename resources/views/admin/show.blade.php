        ...
        <div class="row">
            <div class="col-sm-12 col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="default-according" id="accordion">
                            ...
                            <div class="card">
								...
								@if($data->form == 'six' || $data->form == 'seven')
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class=" col-sm-6 col-lg-6">
                                            <h5> <a href="{{ asset('storage/upload/' . $data->passportimages) }}" download="{{ $data->passportimages }}">
                                                    <img src="{{ asset('storage/upload/' . $data->passportimages) }}" class="size-image">
                                                </a></h5>
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class=" col-sm-6 col-lg-6">
                                            <h5> <a href="{{ asset('storage/upload/' . $data->candidateImage) }}" download="{{ $data->candidateImage }}">
                                                    <img src="{{ asset('storage/upload/' . $data->candidateImage) }}" class="size-image">
                                                </a></h5>
                            ...
                            <div class="card">
                                ...
                                <div class="collapse show" id="collapseeight" aria-labelledby="headingOne" data-bs-parent="#accordion">
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class=" col-sm-6 col-lg-6">
                                            <h5><a href="{{ asset('storage/upload/' . $data->publishedWorks) }}" download="{{ $data->publishedWorks }}">تحميل</a>
                                            </h5>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card">
                                ...
                                <div class="collapse show" id="collapsesaven" aria-labelledby="headingOne" data-bs-parent="#accordion">
                                    <div class="row mt-3">
                                        ...
                                        <div class=" col-sm-6 col-lg-6">
                                            <h5><a href="{{ asset('storage/upload/' . $data->letter) }}" download="{{ $data->letter }}">تحميل</a>
                                            </h5>
                                        </div>
                                    </div>
                                </div>
                    ...
                    @if($data->accept == 0)
                    <a href="{{route('accept',$data->id)}}" class="btn btn-primary">يوافق</a>
                    @endif
                    @endif
