...
<!-- season images page start -->
		<section id="season-view">
            ...
            <div class="col-md-12">
              ...
              <img src="{{asset('/assets/images/2021/one.jpg')}}" alt="" class="image-box-season">
						</div>
						<div class="col-md-6">
              {{-- <h4 class="video-heading">السلام الملكي	</h4> --}}
              <img src="{{asset('/assets/images/2021/two.jpg')}}" alt="" class="image-box-season">
						</div>
						<div class="col-md-6">
              {{-- <h4 class="video-heading">القرآن الكريم	</h4> --}}
              <img src="{{asset('/assets/images/2021/three.jpg')}}" alt="" class="image-box-season">
						</div>
						<div class="col-md-6">
              {{-- <h4 class="video-heading">كلمة الأمير خالد الفيصل	</h4> --}}
              <img src="{{asset('/assets/images/2021/four.jpg')}}" alt="" class="image-box-season">
						</div>

						<div class="col-md-6">
              {{-- <h4 class="video-heading">كلمة أمين الجائزة	</h4> --}}
              <img src="{{asset('/assets/images/2021/five.jpg')}}" alt="" class="image-box-season">
						</div>
            <div class="col-md-6">
              {{-- <h4 class="video-heading">كلمة مستشار رئيس مجلس الأمناء	</h4> --}}
              <img src="{{asset('/assets/images/2021/six.jpg')}}" alt="" class="image-box-season">
						</div>
