        ...
        <section class="tc">
            <div class="container">
                ...
                <ul class="t-list">
                    ...
                    <li class="t-desc">
                        - إن إدارة الجائزة ليست مسؤولة عن أيّ خسارة أو ضرر يلحق بالمتسابق المشارك في الجائزة بما في ذلك الأضرار الناتجة عن قبوله في الجائزة. كما لا تتحمل  مسؤولية أيّ أعطال 
                    </li>
                    <li class="t-desc">
                        تقنية قد تحدث نتيجة لاشتراكه في الجائزة أو تحميله أية مواد أو معلومات ضمن الجائزة.
                    </li>
                </ul>
            </div>
        </section>
