                    ...
                    <form method="POST" enctype="multipart/form-data" action="{{ route('second.paricipation') }}" class="row gx-5 gy-3 candidate-form">
                      ...
                      <!--  <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="textarea" class="form-control" required name="about" id="about">
                            </div>
                        </div> -->
						 <div class="col-md-12">
                                <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="title" class="form-label">عنوان القصيدة الشعرية </label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group upload-file">
                                <label for="publishedWorks" class="form-label">تحميل النص الشعري</label>
                                <input class="form-control" type="file" id="download-file-append" accept="application/pdf, application/vnd.ms-excel" required name="publishedWorks[]" id="publishedWorks">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="sung_poem" class="form-label"> القصيدة المغناة </label>
                                <input type="text" class="form-control" required name="sung_poem" id="sung_poem">
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="singer_name" class="form-label">اسم المطرب </label>
                                    <input type="text" class="form-control" required name="singer_name" id="singer_name">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="composer_name" class="form-label"> اسم الملحن </label>
                            ...
                            <div class="col-md-12">
                                <div class="form-group upload-file">
                                    <label for="song" class="form-label">تحميل الأغنية</label>
                                    <input class="form-control" type="file" id="song" accept="mp4/*" required name="song" id="song">
                                    <span class="upload-file-img authority-song">
                                        <img src="{{ asset('assets/images/file-icon.png') }}" class="img-fluid" alt="">
                                    </span>
                                </div>
                            </div> 
