          ...
          <h2>شروط الترشيح</h2>
              ...
              <ul class="paragraph">
				 <!-- <h6 class="prize mt-3">(خصصت في هذه الدورة لأفضل كتاب يخدم الشعر العربي) </h6> <p> -->
				  ...
				  <p>تقبل الجائزة  ترشيح الأفراد والمؤسسات  وفق المحددات التالية:
</p> <br>
          ...
          <div class="col-md-6 desk-content">
            ...
            <div class="content paragraph-signing">
              ...
              <ul class="paragraph">
				...
				<ul class="paragraph">
				  <p>تقبل الجائزة  ترشيح الأفراد والمؤسسات  وفق المحددات التالية:</p>
				  <li>أن يكون المشروع مؤسسًا لخدمة الشعر العربي، أو أن يكون الشعر العربي جزءًا أصيلًا في بنائه.</li>
				  <li>أن يمثل المشروع إضافةً نوعية مؤثرة في المشهد الشعري العربي .</li>
				  <li>ألا يتعارض المشروع مع أنظمة الملكية الفكرية المعمول بها في المملكة العربية السعودية.</li>
				  <li>ألا يقل عمر المشروع قبل التقدم للجائزة عن ثلاث سنوات منذ انطلاقته.</li>
				  <li>استيفاء جميع البيانات المطلوبة في نموذج الترشيح.</li>
