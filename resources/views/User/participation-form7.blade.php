            ...
            <div class="container">
                <div class="row g-0">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <div class="uni-stnd-txt partic-txt zhd-title ">
                                    ...
                                    <h2 class="animate__animated animate__fadeInRight animate_slower">استمارة ترشيح قصيدة الشاعر الواعد لطلبة التعليم العام  </h2>
                    ...
                    <form method="POST" enctype="multipart/form-data" action="{{ route('second.paricipation') }}" class="row gx-5 gy-3 candidate-form">
                        ...
                        <input type="text" required name="form" value="seven" hidden>
                        <input type="text" required name="type" value="2" hidden>
                        <div class="click-hide row">
                            <h2>معلومات الجھة المرشحة</h2>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="inputName" class="form-label">اسم المدرسة</label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="fieldname" class="form-control" required name="fieldname" id="fieldname">
                                </div>
                            </div>
                     ...
                     <!--   <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" required name="about" id="about">
                            </div>
                        </div> -->
						 <div class="col-md-12">
                                <div class="form-group">
