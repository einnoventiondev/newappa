...
<body>
                ...
                <div class="row g-0">
                    ...
                    <div class="col-md-6">
                        <div class="form-group upload-file">
                            ...
                            <input class="form-control" accept="image/*" type="file" id="download-cv-file-name-first" required name="authentic_cvF" id="candidateImage">
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="authentic_program`+ count +`" id="idNumber">
        </div>
    </div>
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="authentic_place`+ count +`" id="idNumber">
        </div>
    </div>
    ...
    <div class="col-md-6">
        <div class="form-group">
            <label for="city" class="form-label">الهدف</label>
            <input type="text" class="form-control" name="authentic_history1`+ count +`" id="idNumber">
        </div>
    </div>
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="authentic_target`+ count +`" id="idNumber">
        </div>
    </div>
</div>`;
