	...
	<option value="HK">هونج كونج الصينية</option>
                ...
                <div class="col-md-4 padd-l-20 padd-r-20">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control date" required name="authentic_history[]" id="authentic_history">
                    </div>
                </div>
...
let count=1;
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <input type="text" class="form-control date" name="authentic_history[]" id="idNumber">
        </div>
    </div>
