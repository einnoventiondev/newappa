        ...
        <div class="row g-0">
          <div class="col-md-4 title-diwan title-right title-hide-mobile">
            ...
            <div class="box-theatrical">
              <img src="{{asset('./assets/images/blue.svg')}}" class="animate__animated animate__pulse animate__infinite animate_slowy" alt="brown-diamond">
          ...
          <div class="col-md-8">
            ...
            <div class="content">
              ...
              <p>
                <ul class="paragraph">
                  <li> أن ترشح الديوان إحدى دور النشر المعتمدة في اتحاد الناشرين العرب، أو المؤسسات الثقافية العربية، ويحق للأفرادألا يكون المرشح ممن يعمل في أكاديمية الشعر العربي ولا عضوا (بأي صفة) في أي من لجانها في الموسم نفسه.
</li>
              ...
              <span class="prize">٢٠٠,٠٠٠ مئتي ألف ريال</span>
