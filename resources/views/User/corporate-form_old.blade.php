...
<body>
        ...
        <section class="content-container coprate-section">
            <div class="container">
                <div class="row g-0">
                        ...
                        <div class="row">
                            <div class="col-md-10">
                                <div class="uni-stnd-txt partic-txt">
                                    ...
                                    <h2 class="animate__animated animate__fadeInRight animate_slower per-color  mb-3">
                                    </h2>
                                    <h2 class="animate__animated animate__fadeInRight animate_slower  mb-3">جائزة الأمير
                                        عبدالله الفيصل </h2>
                                    <h1 class="animate__animated animate__fadeInRight animate_slower  mb-3"> لأفضل مشروع
                                        في خدمة
                                        الشعر العربي </h1>
                                </div>
                            </div>
                    ...
                    <div class="col-md-12">
                        <div class="radio-btn radio-main">
                            ...
                            <div class="form-check">
                                <input class="form-check-input authentic-radio" checked type="radio"
                            ...
                            <div class="form-check">
                                <input class="form-check-input behalf-radio" type="radio" name="flexRadioDefault"
                    ...
                    <form method="POST" enctype="multipart/form-data" action="{{ route('first.corporation.form') }}"
                        class="row candidate-form corporate-form corporate-form1 ">
                        @csrf
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control date" required name="authentic_date"
                                    id="inputName">
                            </div>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" required name="authentic_company"
                                    id="inputName">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="authentic_options" class="form-label">نوع الترشيح</label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" required name="authentic_manager_name"
                                    id="idNumber">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" required name="authentic_contact"
                                    id="idNumber">
                            </div>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" required name="authentic_program[]"
                                    id="authentic_program">
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control date" required name="authentic_history[]"
                                    id="authentic_history">
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" required name="authentic_place[]"
                                    id="authentic_place">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" required name="authentic_history1[]"
                                    id="authentic_history1">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" required name="authentic_target[]"
                                    id="authentic_target">
                            </div>
                        </div>
                        ...
                        <div class="content add-more-btn-main">
                            <button type="button" class="btn btn-green-icon add-more-program-btn mt-4"><img
                                    src="{{ asset('assets/icons/plus-circle.png') }}" alt=""> إضافة جديد</button>
                        </div>

                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="authentic_link" class="form-label"> رابط الموقع الإلكتروني للتعريف بالمشروع
                                    وأنشطته</label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group upload-file">
                                <label for="download-cv-file-name-first" class="form-label"> جهة الشهادة Pdf, jpg,
                                    png</label>
                                <input class="form-control" accept="image/*" type="file"
                                    id="download-cv-file-name-first" required name="authentic_cv[]" id="candidateImage">
                                <span class="upload-file-img download-cv">
                                    ارفاق ملف <img src="{{ asset('assets/images/cloud-upload-alt.png') }}"
                                        class="img-fluid" alt="">
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="content add-more-btn-main">
                            <button type="button" class="btn btn-green-icon add-more-upload-btn mt-4"><img
                                    src="{{ asset('assets/icons/plus-circle.png') }}" alt=""> إضافة جديد</button>
                        </div>
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" value="1" required name="check2"
                                id="check2">
                            <label class="form-check-label check-label" for="check2">نملك جميع الحقوق الفكرية للمشروع
                                المرشح، وجميع المعلومات المدونة والمرفقة في هذا النموذج صحيحة ودقيقة ونتحمل مسؤولية ما
                                يخالف ذلك.
                            </label>
                        </div>
                    ...
                    <form method="POST" enctype="multipart/form-data" action="{{ route('second.corporation.form') }}"
                        class="row candidate-form corporate-form corporate-form2 d-none">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" required name="behalf_candidate_name"
                                    id="inputName">
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" required name="behalf_company_name"
                                    id="inputName">
                            </div>
                        </div>
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <input type="text" class="form-control" required name="authentic_program[]" id="authentic_program">
        </div>
    </div>
    ...
    <div class="form-group upload-file">
        ...
        <input class="form-control" accept="image/*" type="file" id="authentic_cv1"  required name="authentic_cv[]">
        <span class="upload-file-img download-cv">
