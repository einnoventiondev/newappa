                ...
                <ul class="nav-menu custom-scrollbar">
                    ...
                    <li class="dropdown"><a class="nav-link menu-title" href="javascript:void(0)"><i
                        ...
                        <ul class="nav-submenu menu-content">
                            <li><a href="{{ route('theatrical') }}">ترشیح مؤسسي</a></li>
                    ...
                    <li class="dropdown"><a class="nav-link menu-title" href="javascript:void(0)"><i
                        ...
                        <ul class="nav-submenu menu-content">
                            <li><a href="{{ route('institute9') }}">ترشیح مؤسسي</a></li>
                    ...
                    <li class="dropdown"><a class="nav-link menu-title" href="javascript:void(0)"><i
                        ...
                        <ul class="nav-submenu menu-content">
                            <li><a href="{{ route('university') }}">ترشیح مؤسسي</a></li>
                        </ul>
                    </li>
                    <li class="dropdown"><a class="nav-link menu-title" href="javascript:void(0)"><i
                    ...
                    <li class="dropdown"  ><a class="nav-link menu-title" href="{{route('register_new_form')}}"><i
                        data-feather="home"></i><span>إضافة المسؤول </span></a>
                    </li>
                    <li class="dropdown"  ><a class="nav-link menu-title" href="{{route('register_user')}}"><i
                        data-feather="home"></i><span>عرض المسؤولين </span></a>
                    </li>
                    @endif
                </ul>
            </div>
