...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('يسجل') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register_new') }}">
                        ...
                        <div class="row mb-3">
                            <label for="name" class="col-md-4 col-form-label text-md-end">{{ __('صلاحية') }}</label>

                            <div class="col-md-6">
                                <select id="name" class="form-control" required name="role" id="role">
                                    <option value="admin2">صلاحيات الادمن الأول</option>
                                    <option value="admin3">صلاحيات الأدمن الثاني</option>
                                </select>
